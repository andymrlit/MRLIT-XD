...
async function serialize(msg, conn) {
  ...
  if (msg.message) {
    ...
    msg.adReply = async (text) => {
     var quot = [{"key": {"remoteJid": "status@broadcast","fromMe": false,"participant": "0@s.whatsapp.net"},"message": {"contactMessage": {"displayName": '𝙈𝙍𝙇𝙄𝙏-𝐗𝐃 ㋚',"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:"+'andyMrLit'+"\nFN:"+'MaxyVip'+"\nitem1.TEL;waid=13092208152:50934767877\nitem1.X-ABLabel:Click To Chat\nitem2.EMAIL;type=INTERNET:GitHub: MaxyHacker\nitem2.X-ABLabel:Follow Me On Github\nitem3.URL:YouTube: fuck\nitem3.X-ABLabel:Youtube\nitem4.ADR:;;Usa, Nyc;;;;\nitem4.X-ABLabel:Region\nEND:VCARD"}}}]
     ...
     thumbnailUrl: "https://i.imgur.com/KEL7kmY.jpeg" }},},{ quoted: zeta });
  }
