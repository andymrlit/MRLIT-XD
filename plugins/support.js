...
command({
    ...
    const name = 'support', title = "Andy Mrlit 😎", number = '13092208152', body = "Eʏᴘᴢ☔";
    const image = "https://i.imgur.com/KEL7kmY.jpeg", sourceUrl = 'https://github.com/andymrlit/MRLIT-XD';
